...
/**
 * Clase para pasar el filtro SepiaOp, hereda de BufferedImageOpAdapter.
 * Cambia el aspecto visual de la imagen dandole una sensación de imagen antigua.
 * @author mati
 */
public class SepiaOp extends BufferedImageOpAdapter{
    
    /**
     * Constructor para crear un nuevo objeto sepiaOp
     */
    public SepiaOp(){
    }

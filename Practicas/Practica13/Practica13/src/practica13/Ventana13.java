...
public class Ventana13 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        listaReproduccion.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        listaReproduccion.setMaximumSize(new java.awt.Dimension(64, 22));
        jToolBar1.add(listaReproduccion);

        grabar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/iconosPracticaSonido/record24x24.png"))); // NOI18N
        ...
        jPanel12.setMaximumSize(new java.awt.Dimension(170, 125));
        jPanel12.setMinimumSize(new java.awt.Dimension(170, 125));
        jPanel12.setPreferredSize(new java.awt.Dimension(170, 125));
        ...
        jPanel8.setMaximumSize(new java.awt.Dimension(110, 125));
        jPanel8.setMinimumSize(new java.awt.Dimension(110, 125));
        jPanel8.setPreferredSize(new java.awt.Dimension(110, 125));
        ...
        archivo.add(abrir_audio);

        grabar_audio.setText("Grabar Audio");
        archivo.add(grabar_audio);
...
//                BufferedImage img = ImageIO.read(f);
                 // ventana_interna vi = new ventana_interna("Sonido", this); // habra que poner un nuevo sonido...
//                vi.lienzo1().setImage(img);
...
//                vi.setVisible(true);
    ...
    private javax.swing.JComboBox<String> listaReproduccion;
    ...
    private practica13.ventana_interna externa;
    private practica13.ventana_interna v_interna;
